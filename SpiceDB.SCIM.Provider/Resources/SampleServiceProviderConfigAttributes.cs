...
namespace SpiceDB.SCIM.Provider.Resources
{
    ...
    public static class SampleServiceProviderConfigAttributes
    {
        public static AttributeScheme DocumentationUriAttributeScheme
        {
            get
            {
                AttributeScheme documentationUriScheme =
                    new AttributeScheme("documentationUri", AttributeDataType.reference, false)
                    {
        ...
        public static AttributeScheme ChangePasswordAttributeScheme
        {
            get
            {
                AttributeScheme changePasswordScheme =
                    new AttributeScheme("changePassword", AttributeDataType.complex, false)
                    {
        ...
        public static AttributeScheme AuthenticationSchemesAttributeScheme
        {
            get
            {
                AttributeScheme authenticationSchemesScheme =
                    new AttributeScheme("authenticationSchemes", AttributeDataType.complex, true)
                    {
        ...
        public static AttributeScheme MaxOperationsSubAttributeScheme
        {
            get
            {
                AttributeScheme maxOperationsScheme =
                    new AttributeScheme("maxOperations", AttributeDataType.integer, false)
                    {
        ...
        public static AttributeScheme MaxPayloadSizeSubAttributeScheme
        {
            get
            {
                AttributeScheme maxPayloadSizeScheme =
                    new AttributeScheme("maxPayloadSize", AttributeDataType.integer, false)
                    {
