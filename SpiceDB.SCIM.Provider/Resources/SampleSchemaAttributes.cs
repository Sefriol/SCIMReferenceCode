    ...
    public class SampleSchemaAttributes
    {
        ...
        public static AttributeScheme MultiValuedSubAttributeScheme
        {
            get
            {
                ...
                {
                    Description =
                        SampleConstants.DescriptionAttributeMultiValued,
                    Mutability = Mutability.readOnly,
                    Required = true,
                };
        ...
        public static AttributeScheme DescriptionSubAttributeScheme
        {
            get
            {
                ...
                {
                    Description =
                        SampleConstants.DescriptionAttributeDescription,
                    Mutability = Mutability.readOnly,
                    CaseExact = true
                };
                return descriptionScheme;
        ...
        public static AttributeScheme CanonicalValuesSubAttributeScheme
        {
            get
            {
                AttributeScheme canonicalValuesScheme =
                    new AttributeScheme("canonicalValues", AttributeDataType.@string, true)
                    {
                        Description = SampleConstants
                            .DescriptionAttributeCanonicalValues,
                        Mutability = Mutability.readOnly,
                        CaseExact = true
                    };
        ...
        public static AttributeScheme ReferenceTypesSubAttributeScheme
        {
            get
            {
                AttributeScheme referenceTypesScheme =
                    new AttributeScheme("referenceTypes", AttributeDataType.@string, true)
                    {
                        Description = SampleConstants
                            .DescriptionAttributeReferenceTypes,
                        Mutability = Mutability.readOnly,
                        CaseExact = true
                    };
        ...
        public static AttributeScheme SubAttributesSubAttributeScheme
        {
            get
            {
                AttributeScheme subAttributesScheme =
                    new AttributeScheme("subAttributes", AttributeDataType.complex, true)
                    {
                        Description = SampleConstants
                            .DescriptionAttributeSubAttributes,
                        Mutability = Mutability.readOnly,
                    };
